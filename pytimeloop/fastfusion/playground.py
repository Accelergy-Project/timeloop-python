...
def get_sims():
    ...
    sims = [
        ...
        makesim("M5", {"C4": {"M1", "N3"}, "B5": {"N3", "N4"}, "C5": {"M1", "N4"}}),
        makesim("M6", {"C5": {"M1", "N3"}, "B6": {"N3", "N4"}, "C6": {"M1", "N4"}}),
        makesim("M7", {"C6": {"M1", "N3"}, "B7": {"N3", "N4"}, "C7": {"M1", "N4"}}),
    ]
    return sims
...
def run(sims: list[SIM]):
    ...
    while sims:
        ...
        [s2.consolidate(live_tensors) for s2 in s]
