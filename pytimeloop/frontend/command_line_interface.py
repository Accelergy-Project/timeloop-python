...
def parse_args() -> argparse.Namespace:
    ...
    Examples: https://github.com/Component-Project/timeloop-accelergy-exercises
    """
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="List components and actions supported by Component.",
    )
...
def get_version(input_files: List[str]) -> object:
    ...
    if version == "0.4":
        ...
        import pytimeloop.frontend.v3 as tl
    else:
...
def main():
    ...
    spec = tl.Specification.from_yaml(
