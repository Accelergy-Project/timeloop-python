...
class ListNode(Node, list):
    ...
    def __getitem__(self, key: Union[str, int]) -> Any:
        ...
        if isinstance(key, int):
            ...
            raise TypeError(f"ListNode {self.get_name()} got a non-str non-int index: {key}")
        ...
        raise KeyError(f"No element with name {key} found in {self.get_name()}. "
